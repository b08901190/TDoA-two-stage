# -*- coding: utf-8 -*-
"""brand_new_demo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TVdjWxpqV6JmE__3n7WubiHVGtEyLayb
"""
...
for i in range(11):
    x = 0
    for j in range(0+num_of_same_height*i,num_of_same_height+num_of_same_height*i):
        x += ( abs(result["error_x"][j])**2 + abs(result["error_y"][j])**2 ) ** 0.5
    all[i] = x
for i in range(11):
    diffrent_height_error_wo_z[i] = all[i]/num_of_same_height
...
for i in range(11):
    x = 0
    for j in range(0+num_of_same_height*i,num_of_same_height+num_of_same_height*i):
        x += ( (result["error_distance"][j]) ** 0.5 )/num_of_same_height
